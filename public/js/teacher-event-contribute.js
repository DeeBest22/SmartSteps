document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayEventInfo() {
        ...
        const requiredQuestions = teacherData.teacher.subject === 'English' ? 60 : 40;
            ...
            <div class="event-info-card">
                ...
                <div class="event-info-details">
                    ...
                    <div class="info-item">
                        ...
                        <span>Minimum Required: <strong>${requiredQuestions} questions</strong></span>
                    </div>
                    <div class="info-item">
                        <i class="fas fa-check-circle"></i>
                        <span>Current: <strong>${myProgress} questions</strong></span>
                    </div>
                ...
                <div class="progress-container">
                    <div class="progress-bar">
                        <div class="progress-fill" style="width: ${Math.min((myProgress / requiredQuestions) * 100, 100)}%"></div>
                    </div>
                    <div class="progress-text">${myProgress} questions added (minimum ${requiredQuestions} required)</div>
                </div>
            </div>
        `;
